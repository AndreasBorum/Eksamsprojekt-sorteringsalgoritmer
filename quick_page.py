...
class QuickSortPage(AlgorithmPage):
    def __init__(self, app):
        ...
        self.description_label = ctk.CTkLabel(self.description_frame, text=import_text.home_page_text, text_color="black", font=ctk.CTkFont(size=14), wraplength=200, justify=tk.CENTER)
