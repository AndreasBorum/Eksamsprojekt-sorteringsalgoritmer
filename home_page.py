...
class HomePage(ctk.CTkFrame):
    def __init__(self, app):
        ...
        intro_image = ctk.CTkImage(Image.open("images\intro page.png"), size=(image_width, image_height))
        intro_btn = ctk.CTkButton(menu_frame, image= intro_image , text="Intro", compound="top", command=lambda:app.show_frame_by_number(1))
        ...
        bubble_image = ctk.CTkImage(Image.open(r"images\bubble page.png"), size=(image_width, image_height))
        bubble_btn = ctk.CTkButton(menu_frame, image= bubble_image , text="Bubblesort", compound="top", command=lambda:app.show_frame_by_number(2))
        bubble_btn.grid(row=2, column=0, padx=10, pady=10)

        quick_image = ctk.CTkImage(Image.open("images\quick page.png"), size=(image_width, image_height))
        quick_btn = ctk.CTkButton(menu_frame, image= quick_image , text="Quicksort", compound="top", command=lambda:app.show_frame_by_number(3))
        quick_btn.grid(row=2, column=1, padx=10, pady=10)

        coming_soon_image = ctk.CTkImage(Image.open("images\coming soon.jpg"), size=(image_width, image_height))
        coming_soon_btn = ctk.CTkButton(menu_frame, image= coming_soon_image , text="Comming soon", compound="top")
        ...
        big_o_image = ctk.CTkImage(Image.open(r"images\big O page.png"), size=(image_width, image_height))
        big_o_btn = ctk.CTkButton(menu_frame, image= big_o_image , text="Big O notation", compound="top", command=lambda:app.show_frame_by_number(4))
