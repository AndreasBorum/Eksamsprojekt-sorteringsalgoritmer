...
class BigOPage(ctk.CTkFrame):
    def __init__(self, app):
        ...
        self.header_label = ctk.CTkLabel(
            self, text="Big O page", justify=tk.CENTER, text_color="black", font=ctk.CTkFont(size=20, weight="bold"))
        self.header_label.grid(row=0, column=0, columnspan=2,
                               sticky="nsew", padx=10, pady=10)

        self.intro_label = CTkWrappingLabel(
            self, text=import_text.bigo_page_text, text_color="black", justify=tk.LEFT)
        self.intro_label.grid(row=1, column=0, sticky="new", padx=10, pady=10)

        flowchart_image = ctk.CTkImage(
            Image.open("images\BigO.png"), size=(600, 500))
